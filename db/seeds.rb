...
# Following
Follows.create(follower_id: '1', following_id: '2')
Follows.create(follower_id: '1', following_id: '3')
Follows.create(follower_id: '1', following_id: '4')
Follows.create(follower_id: '1', following_id: '5')
Follows.create(follower_id: '2', following_id: '1')
Follows.create(follower_id: '2', following_id: '3')
Follows.create(follower_id: '2', following_id: '4')
Follows.create(follower_id: '2', following_id: '5')
Follows.create(follower_id: '3', following_id: '1')
Follows.create(follower_id: '3', following_id: '2')
Follows.create(follower_id: '3', following_id: '4')
Follows.create(follower_id: '3', following_id: '5')
Follows.create(follower_id: '4', following_id: '1')
Follows.create(follower_id: '4', following_id: '2')
Follows.create(follower_id: '4', following_id: '3')
Follows.create(follower_id: '4', following_id: '5')
