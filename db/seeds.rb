...
User.find(2).images.create!(url: 'http://images.nationalgeographic.com/wpf/media-live/photos/000/067/cache/pastoral-landscape_6792_600x450.jpg', lat: '53.3428', long: '6.2661', caption: "baby When I stood in my baby Baby ancestor/'s backyard, I realized how deep roots grow.")
User.find(3).images.create!(url: 'http://backroads_web.s3.amazonaws.com/images/trips/2013/slideshowsnew/BIRQ-ireland-biking-7.jpg', lat: '52.6675', long: '8.6261', caption: "When I stepped baby outside my comfort zone, I realized the grass is always greener on this side.")
